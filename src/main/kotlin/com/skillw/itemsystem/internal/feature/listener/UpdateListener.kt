...
import com.skillw.itemsystem.internal.feature.ItemUpdater.updateIfNeed
...
private object UpdateListener {
    ...
    fun onDrop(e: PlayerDropItemEvent) {
        e.itemDrop.itemStack = e.itemDrop.itemStack.updateIfNeed(e.player)
    }

    @SubscribeEvent(priority = EventPriority.MONITOR, ignoreCancelled = true)
    fun onPickup(e: PlayerPickupItemEvent) {
        e.item.itemStack = e.item.itemStack.updateIfNeed(e.player)
    }
